...
var contrainer = document.getElementById("pictures");
for (let i = 0; i < picArray.length; i++) {
    var picDiv = document.createElement("div");
    picDiv.className = "picture";
    
    var title = document.createElement("h2");
    title.innerText =  picArray[i].title;
    picDiv.appendChild(title);

    var caption = document.createElement("h3");
    caption.innerText = picArray[i].caption;
    picDiv.appendChild(caption);

    
    var description = document.createElement("p");
    description.innerText = picArray[i].description;
    picDiv.appendChild(description);
